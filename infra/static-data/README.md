...
- `public-catalog.discovery.json` e o indice deterministico de discovery institucional, separado do snapshot principal, com links oficiais de portal de curso e curriculo.
